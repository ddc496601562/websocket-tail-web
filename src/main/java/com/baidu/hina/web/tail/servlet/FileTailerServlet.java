...
import static com.baidu.hina.web.tail.util.ConstantUtil.*;
...
public class FileTailerServlet extends WebSocketServlet {
    ...
    public FileTailerServlet() {
        ...
        logTailFlushInterval = PropertyConfigUtil.getLong(pMap, LOG_TAIL_FLUSH_INTERVAL_CONFIG_KEY, LOG_TAIL_FLUSH_INTERVAL_DEFAULT);
